...
def test_knowledge_acquisition_research_topic():
    ...
    mock_fetch = MagicMock(
        return_value={
            "title": "Quantum Mechanics",
            "text": "We define state space as Hilbert space. The wave function is defined as a complex function. Theorem: Normalization. $$P(x, t) = |\\Psi|^2$$",
            "url": "https://example.com/qm",
        }
    )
