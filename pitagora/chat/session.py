...
class ChatSessionState:
    ...
    def _default_system_prompt() -> str:
        return (
            ...
            "1. MANDATORY VISUALIZATION & PLOTTING TOOL: Whenever explaining physical phenomena, "
            "wavefunctions, potentials, harmonic oscillators, probability densities, or mathematical relations, "
            ...
            "2. BIAS FOR ACTION & DIRECT DEMONSTRATION: Do not trap the user in passive, "
            "open-ended Socratic question loops. Immediately provide the core mathematical formulation, "
            "precise physical intuition, and an interactive exploration hook.\n"
            "3. CONCRETE CONCEPTUAL BREAKDOWN: Give rigorous, structured explanations with "
            "exact formulas and physical meaning for each variable.\n"
            "4. MATHEMATICAL PRECISION: Always use clean LaTeX notation ($...$ inline, $$...$$ display) "
            "and proper Dirac/operator notation (|ψ⟩, ⟨x|, Â, ħ, ℂ, ∫, ∑). Never emit broken escape sequences.\n"
            "5. ACTIONABLE CLOSING: Conclude explanations with concrete next actions, parameter "
