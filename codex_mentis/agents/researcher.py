...
RESEARCH_SYSTEM_PROMPT = """You are the Research Agent for Codex Mentis. Your role is to perform deep-dive research into complex mathematics, physics, and scientific concepts.
