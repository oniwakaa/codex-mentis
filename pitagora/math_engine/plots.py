...
class MathPlotter:
    def __init__(self):
        self._last_fig: Optional[mplt.Figure] = None
    ...
    def plot_function(self, expr: str, x_range: Tuple[float, float], title: str = "Function Plot") -> None:
        ...
        x_plt = [x for x, y in zip(x_vals, y_vals) if not np.isnan(y)]
    ...
    def plot_parametric(self, x_expr: str, y_expr: str, t_range: Tuple[float, float], title: str = "Parametric Plot") -> None:
    ...
    def plot_vector_field(self, Fx_expr: str, Fy_expr: str, x_range: Tuple[float, float], y_range: Tuple[float, float], title: str = "Vector Field") -> None:
    ...
    def plot_surface(self, expr: str, x_range: Tuple[float, float], y_range: Tuple[float, float], title: str = "Surface Plot") -> None:
    ...
    def plot_scatter(self, x_data: List[float], y_data: List[float], title: str = "Scatter Plot") -> None:
